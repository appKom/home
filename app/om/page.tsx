    ...
    <div className="min-h-screen text-white">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 text-center">
          ...
          >
            <HiOutlineSparkles className="mr-2 hidden sm:inline-block h-8 w-8 text-[#FFD700]" />
            Applikasjonskomiteen
            <HiOutlineSparkles className="ml-2 hidden sm:inline-block h-8 w-8 text-[#FFD700]" />
          </motion.h1>
        </div>
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          >
            <div className="rounded-xl bg-gray-900/50 p-6 backdrop-blur">
              <h2 className="mb-4 text-2xl font-semibold text-[#FFD700]">Om Appkom</h2>
            ...
            <div className="rounded-xl bg-gray-900/50 p-6 backdrop-blur">
              <h2 className="mb-4 text-2xl font-semibold text-[#FFD700]">Våre Prosjekter</h2>
              <p className="text-gray-300">
            ...
            <div className="rounded-xl bg-gray-900/50 p-6 backdrop-blur">
              <h2 className="mb-4 text-2xl font-semibold text-[#FFD700]">Bli Med i Appkom</h2>
              <p className="text-gray-300">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="rounded-xl bg-gray-900/50 p-6 text-center backdrop-blur">
                <MdGroups2 className="mx-auto mb-2 h-8 w-8 text-[#FFD700]" />
                <div className="text-3xl font-bold text-[#FFD700]">{getNumberOfCurrentMembers()}</div>
                <div className="mt-2 text-sm text-gray-400">Medlemmer</div>
              </div>
              <div className="rounded-xl bg-gray-900/50 p-6 text-center backdrop-blur">
                <FaBoxOpen className="mx-auto mb-2 h-8 w-8 text-[#FFD700]" />
                <div className="text-3xl font-bold text-[#FFD700]">{getNumberOfProjects()}</div>
                <div className="mt-2 text-sm text-gray-400">Aktive Prosjekter</div>
              </div>
              <div className="rounded-xl bg-gray-900/50 p-6 text-center backdrop-blur">
                <PiPlant className="mx-auto mb-2 h-8 w-8 text-[#FFD700]" />
                <div className="text-3xl font-bold text-[#FFD700]">{new Date().getFullYear() - 2020}</div>
        ...
        >
          <div className="inline-block rounded-xl w-full bg-[#FFD700] p-8">
