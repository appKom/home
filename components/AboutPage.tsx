...
interface Props {
  numberOfCurrentMembers: number;
  numberOfProjects: number;
}

const AboutPage = ({ numberOfCurrentMembers, numberOfProjects }: Props) => {
  return (
      ...
      <div className="grid gap-12 lg:grid-cols-2">
        ...
        >
          <div className="rounded-xl bg-gray-900/50 p-6 backdrop-blur">
            <h2 className="mb-4 text-2xl font-semibold text-onlineOrange">
              Om Appkom
            </h2>
            <p className="text-gray-300">
              Applikasjonskomiteen (Appkom) er en komité under Online,
              linjeforeningen for informatikk ved NTNU. Vårt mål er å utvikle
              programvare som er nyttig for informatikkstudenter.
            </p>
          </div>
          ...
          <div className="rounded-xl bg-gray-900/50 p-6 backdrop-blur">
            ...
            <p className="text-gray-300">
              For å nevne noen har har vi tidligere utviklet <b>Online-appen</b>
              , <b>Infoskjermen på A4</b>, <b>Onlinefondet.no</b>,{" "}
              <b>Komitéopptaksystemet</b>, <b>Autobank</b> og diverse{" "}
              <b>spill</b>. Vi jobber for tiden med å fullføre flere prosjekter
              samt vedlikeholde og forberede våre lanserte prosjekter. Vi er
              alltid på utkikk etter å starte opp noe nytt og spennende, og
              setter stor pris på nye ideer.
            </p>
          </div>
          ...
          <div className="rounded-xl bg-gray-900/50 p-6 backdrop-blur">
            ...
            <p className="text-gray-300">
              Er du interessert i å bli med på våre spennende prosjekter, eller
              har du lyst til å starte opp ditt eget prosjekt? Appkom er stedet
              for deg! Vi krever ikke forhåndskunnskaper, det er kun viktig at
              du er engasjert og viser initiativ. Har du noen spørsmål
              underveis, er det bare å spørre din progge-fadder, som vil være
              din mentor i oppstarten.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="rounded-xl bg-gray-900/50 p-6 text-center backdrop-blur">
              ...
              <div className="text-3xl font-bold text-onlineOrange">
